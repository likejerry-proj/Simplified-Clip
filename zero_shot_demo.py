"""
python zero_shot_demo.py --checkpoint_path /GPFS/rhome/kejinli/workspace/multi-modal/clip-training-torch/saved_checkpoints/checkpoint_34_64715.pt --img_path /GPFS/rhome/kejinli/workspace/multi-modal/clip-training-torch/img/1.jpg --show_prediction
"""
...
def predict_class(model, images, image_names, dataset_classes, tokenizer, device):
    ...
    with torch.no_grad():
        ...
        for image, image_name in zip(images, image_names):
            ...
            # top 5 predictions
            values, indices = similarity[0].cpu().topk(10)
            print("------------------------")
...
def zero_shot_demo():
    ...
    # CIFAR100 classes
    dataset_classes = ['strong_man','man','smiling_guy','smiling_black_guy','crying_black_guy','white_man','apple', 'aquarium_fish', 'baby', 'bear', 'beaver', 'bed', 'beetle', 'bicycle', 'bottle', 'bowl', 'boy', 'bridge', 'bus', 'butterfly', 'camel', 'can', 'castle', 'caterpillar', 'cattle', 'chair', 'chimpanzee', 'clock', 'cloud', 'cockroach', 'couch', 'crab', 'crocodile', 'cup', 'dinosaur', 'dolphin', 'elephant', 'flatfish', 'forest', 'fox', 'girl', 'hamster', 'house', 'kangaroo', 'keyboard', 'lamp', 'lawn_mower', 'leopard', 'lion', 'lizard', 'lobster', 'maple_tree', 'motorcycle', 'mountain', 'mouse', 'mushroom', 'oak_tree', 'orange', 'orchid', 'otter', 'palm_tree', 'pear', 'pickup_truck', 'pine_tree', 'plain', 'plate', 'poppy', 'porcupine', 'possum', 'rabbit', 'raccoon', 'ray', 'road', 'rocket', 'rose', 'sea', 'seal', 'shark', 'shrew', 'skunk', 'skyscraper', 'snail', 'snake', 'spider', 'squirrel', 'streetcar', 'sunflower', 'sweet_pepper', 'table', 'tank', 'telephone', 'television', 'tiger', 'tractor', 'train', 'trout', 'tulip', 'turtle', 'wardrobe', 'whale', 'willow_tree', 'wolf', 'woman', 'worm']
